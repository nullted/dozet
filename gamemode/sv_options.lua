...
GM.RepairPointsPerHealth = CreateConVar("zs_repairpointsperhealth", "220", FCVAR_ARCHIVE + FCVAR_NOTIFY, "Specifies the amount of repairing for players to be given a point. For use with nails and such."):GetInt()
