...
LANGUAGE.prop_obj_exit_h							= "Бегите ниггеры!!"
...
LANGUAGE.class_the_tickle_monster					= "Длиннорукий уебан"
LANGUAGE.class_nightmare							= "Пылающий Огонь"
LANGUAGE.class_ancient_nightmare					= "Древний Огонь"
LANGUAGE.class_devourer								= "Devourer"
LANGUAGE.class_pukepus								= "Pukepus"
LANGUAGE.class_bonemesh								= "Bonemesh"
LANGUAGE.class_crow									= "Ворона"
LANGUAGE.class_wilowisp								= "Светло-О-Ляк"
LANGUAGE.class_coolwisp								= "Ледянной Светляк"
LANGUAGE.class_zombie_torso							= "Zombie Torso"
LANGUAGE.class_zombie_legs							= "Zombie Legs"
LANGUAGE.class_wraith								= "Душа"
LANGUAGE.class_tormented_wraith						= "Страдающая Душа"
...
LANGUAGE.class_frostshade							= "Ледянной Шейд"
LANGUAGE.class_butcher								= "Мясник"
LANGUAGE.class_gravedigger							= "Гробовщик"
LANGUAGE.class_flesh_creeper						= "Хранитель неста"
LANGUAGE.class_gore_child							= "Gore Child"
LANGUAGE.class_giga_gore_child						= "Малыш"
LANGUAGE.class_shadow_gore_child					= "Shadow Child"
LANGUAGE.class_giga_shadow_child					= "Гига Негр Малыш"
LANGUAGE.class_asskicker							= "Надиратель жоп"
LANGUAGE.class_shitslapper							= "Большой торс баракота"
...
LANGUAGE.class_tormented_boss						= "Душа Детдомвца"
LANGUAGE.class_shadow_r      						= "Shadow nigger"
LANGUAGE.class_bartor        						= "Часть баракота"
...
LANGUAGE.description_baracat					= "Тойка охуел и добавил баракота..."
