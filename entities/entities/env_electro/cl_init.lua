...
function ENT:Initialize()
	...
	self:EmitSound("physics/metal/metal_sheet_impact_bullet"..math.random(1, 7)..".wav", 255, math.random(160, 180))
	self:EmitSound("ambient/fire/gascan_ignite1"..math.random(1, 7)..".wav", 255, math.random(160, 180))
	...
	for i=1, 120 do
		...
		local particle = emitter:Add("effects/spark", pos + Vector(0, 0, 16) + fwd * 8)
